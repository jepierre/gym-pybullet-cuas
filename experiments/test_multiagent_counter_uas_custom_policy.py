...
if __name__ == "__main__":
    ...
    #     checkpoint = f.read()
    checkpoint = r"/home/marcus/Documents/workspace/reinforcement-learning/pybullet/gym-pybullet-drones/experiments/learning/results/save-leaderfollower-4-cc-kin-vel-06.20.2021_00.30.49/PPO/PPO_this-aviary-v0_10867_00000_0_2021-06-20_00-30-54/checkpoint_000500/checkpoint-500"
    agent.restore(checkpoint)

    #### Extract and print policies ############################
    # policy0 is a custom policy
